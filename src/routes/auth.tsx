        ...
        {mode === 'login' ? (
          ...
          >
            ...
            <div className="relative flex py-2 items-center">
              ...
              <span className="flex-shrink mx-4 text-[8px] font-mono text-zinc-500 uppercase tracking-widest">OR SECURE PASS-THROUGH</span>
              <div className="flex-grow border-t border-white/5"></div>
            </div>
            ...
            <button
              type="button"
              onClick={() => {
                window.location.href = `/api/auth/login/social?provider=google&callbackURL=${window.location.origin}`
              }}
              className="w-full bg-zinc-950/40 text-white font-mono text-[10px] tracking-widest py-4 hover:bg-white/5 transition-all duration-300 flex items-center justify-center gap-2 uppercase border border-white/10 hover:border-white relative overflow-hidden group"
            >
              <div className="absolute top-0 right-0 h-1 w-1 bg-white/20 group-hover:bg-white transition-colors" />
              <div className="absolute bottom-0 left-0 h-1 w-1 bg-white/20 group-hover:bg-white transition-colors" />
